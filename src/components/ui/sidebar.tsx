/** biome-ignore-all lint/suspicious/noDocumentCookie: Using on shadcn */
/** biome-ignore-all lint/nursery/noShadow: Using on shadcn */
"use client";
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 font-medium text-sidebar-foreground/70 text-sm outline-hidden ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
